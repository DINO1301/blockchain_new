...
const Home = () => {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* --- HERO SECTION --- */}
      <div className="relative bg-gradient-to-br from-indigo-900 via-blue-800 to-indigo-900 text-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 py-20 md:py-32 relative z-10">
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="md:w-1/2 relative hidden md:block">
              <div className="relative z-10 bg-gradient-to-tr from-white/10 to-white/5 backdrop-blur-lg border border-white/20 p-8 rounded-3xl shadow-2xl transform rotate-3 hover:rotate-0 transition duration-500">
              ...
              <div className="absolute top-10 -right-10 w-64 bg-indigo-600 p-6 rounded-2xl shadow-xl -z-10 opacity-80 transform -rotate-6"></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-24">
        <div className="text-center mb-16">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">Tại sao chọn MediTrack?</h2>
